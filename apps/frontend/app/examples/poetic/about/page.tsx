  ...
  return (
    <main className="px-6">
      <section className="mx-auto max-w-3xl">
        <h1 className="text-pretty text-4xl font-bold leading-[1.2] md:text-5xl">
          The Archive is an experimental film practice supporting{" "}
          <span className="font-[family-name:var(--font-poetic-script)] text-[#ff5da2]">
            interdisciplinary study
          </span>{" "}
          in art, code, memory and critical theory.
        </h1>
        <p className="mt-8 text-base leading-relaxed text-[#f4f1ea]/75">
      ...
      <section className="mx-auto mt-16 max-w-3xl">
        <p className="text-xs uppercase tracking-[0.2em] text-[#7cffb2]">how we work</p>
        <div className="mt-6 space-y-4">
          {principles.map((p) => (
            <div
              key={p.n}
              className="flex gap-5 rounded-2xl border border-[#f4f1ea]/20 p-5"
            >
              ...
              <div>
                ...
                <p className="mt-1 text-sm leading-relaxed text-[#f4f1ea]/70">{p.body}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="mx-auto mt-16 max-w-3xl rounded-2xl bg-[#7cffb2] p-8 text-[#0c0c0c]">
        <h2 className="font-[family-name:var(--font-poetic-script)] text-3xl">say hello</h2>
        <p className="mt-2 max-w-md text-sm leading-relaxed">
          For screenings, study sessions, or just to send a postcard from wherever you are watching.
        </p>
        <p className="mt-4 text-sm font-bold">hello@thearchive.example &middot; @the.archive</p>
      </section>
    </main>
  )
}
